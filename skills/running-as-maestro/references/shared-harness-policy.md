# Shared maestro policy for non-Codex harnesses
...
read [model-selection.md](model-selection.md). For a
...
Determine which non-Codex harness you are running in and apply only the matching
